...
const UserCard = (props) => (
  <Card styleName={isBrowser? "user-card": "user-card2"}>
    {props.displayPicture ? (
                  <Image src={props.displayPicture} avatar ui={false} style={{height:isBrowser? "128px":"69px", width:isBrowser? "132px":"71px"}}/>
                ) : (
                  <Image src={createImageFromInitials(128,props.name, "#6435C9")} avatar ui={false} style={{height:isBrowser? "128px":"69px" ,  width:isBrowser? "132px":"71px"}}/>
                )}
